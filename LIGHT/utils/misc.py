...
def init_training(args):
    if not args.resume and (not args.distributed or is_main_process()):
...
def load_checkpoint(args, model_without_ddp, optimizer, scheduler):
    if args.resume:
...
def save_checkpoint(args, model_without_ddp, optimizer, scheduler, epoch):
    checkpoint_path = os.path.join(args.checkpoint_dir, 'last_checkpoint.pth')
    state_dict = {
